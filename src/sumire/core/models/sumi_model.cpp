...
namespace sumire {
	...
	std::vector<VkVertexInputAttributeDescription> SumiModel::Vertex::getAttributeDescriptions() {
		...
		attributeDescriptions.push_back({5, 0 , VK_FORMAT_R32G32B32_SFLOAT, offsetof(Vertex, tangent)});
		attributeDescriptions.push_back({6, 0 , VK_FORMAT_R32G32_SFLOAT,    offsetof(Vertex, uv)});
